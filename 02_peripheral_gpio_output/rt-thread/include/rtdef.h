...
#define INIT_PLATFORM_EXPORT(fn)        INIT_EXPORT(fn, "1.2.0")
/* init fix-clock, clock... */
#define INIT_FIX_CLK_EXPORT(fn)        INIT_EXPORT(fn, "1.2.1")
#define INIT_CLK_EXPORT(fn)        INIT_EXPORT(fn, "1.2.2")
...
enum rt_object_class_type
{
    ...
    RT_Object_Class_Service       = 0x10,      /**< The object is a service */
    RT_Object_Class_Custom        = 0x11,      /**< The object is a custom object */
