...
struct rt_spi_ops
{
    ...
    rt_ssize_t (*xfer)(
        struct rt_spi_device *device, struct rt_spi_message *message);
};
...
typedef rt_err_t (*__kpi_rt_spi_driver_register)(struct rt_spi_driver *driver);
typedef rt_err_t (*__kpi_rt_spi_device_register)(struct rt_spi_device *device);
 ...
 */
typedef rt_err_t (*__kpi_rt_spi_bus_register)(
    struct rt_spi_bus *bus, const char *name, const struct rt_spi_ops *ops);
 ...
 * @return rt_err_t error code
 */
typedef rt_err_t (*__kpi_rt_spi_bus_attach_device)(struct rt_spi_device *device,
    const char *name,
    const char *bus_name,
    void *user_data);
 ...
 * @return rt_err_t error code
 */
typedef rt_err_t (*__kpi_rt_spi_bus_attach_device_cspin)(
 ...
 */
typedef rt_err_t (*__kpi_rt_spi_bus_configure)(struct rt_spi_device *device);
 ...
 */
typedef rt_err_t (*__kpi_rt_spi_take_bus)(struct rt_spi_device *device);
 ...
 */
typedef rt_err_t (*__kpi_rt_spi_release_bus)(struct rt_spi_device *device);
 ...
 */
typedef rt_err_t (*__kpi_rt_spi_take)(struct rt_spi_device *device);
 ...
 */
typedef rt_err_t (*__kpi_rt_spi_release)(struct rt_spi_device *device);
 ...
 */
typedef rt_err_t (*__kpi_rt_spi_configure)(
    struct rt_spi_device *device, struct rt_spi_configuration *cfg);
 ...
 * @return rt_err_t error code
 */
typedef rt_err_t (*__kpi_rt_spi_send_then_recv)(struct rt_spi_device *device,
    const void *send_buf,
 ...
 */
typedef rt_err_t (*__kpi_rt_spi_send_then_send)(struct rt_spi_device *device,
 ...
 */
typedef rt_ssize_t (*__kpi_rt_spi_transfer)(struct rt_spi_device *device,
    const void *send_buf,
    void *recv_buf,
    rt_size_t length);
 ...
 * @return rt_err_t error code
 */
typedef rt_err_t (*__kpi_rt_spi_sendrecv8)(
    struct rt_spi_device *device, rt_uint8_t senddata, rt_uint8_t *recvdata);
 ...
 * @return rt_err_t error code
 */
typedef rt_err_t (*__kpi_rt_spi_sendrecv16)(
    struct rt_spi_device *device, rt_uint16_t senddata, rt_uint16_t *recvdata);
 ...
 */
typedef struct rt_spi_message *(*__kpi_rt_spi_transfer_message)(
    struct rt_spi_device *device, struct rt_spi_message *message);
...
KPI_EXTERN(rt_spi_driver_register);
KPI_EXTERN(rt_spi_device_register);
KPI_EXTERN(rt_spi_bus_register);
KPI_EXTERN(rt_spi_bus_attach_device);
KPI_EXTERN(rt_spi_bus_attach_device_cspin);
KPI_EXTERN(rt_spi_bus_configure);
KPI_EXTERN(rt_spi_take_bus);
KPI_EXTERN(rt_spi_release_bus);
KPI_EXTERN(rt_spi_take);
KPI_EXTERN(rt_spi_release);
KPI_EXTERN(rt_spi_configure);
KPI_EXTERN(rt_spi_send_then_recv);
KPI_EXTERN(rt_spi_send_then_send);
KPI_EXTERN(rt_spi_transfer);
KPI_EXTERN(rt_spi_sendrecv8);
KPI_EXTERN(rt_spi_sendrecv16);
KPI_EXTERN(rt_spi_transfer_message);
...
*/
rt_inline rt_size_t rt_spi_recv(
    struct rt_spi_device *device, void *recv_buf, rt_size_t length)
{
 ...
 */
rt_inline rt_size_t rt_spi_send(
    struct rt_spi_device *device, const void *send_buf, rt_size_t length)
{
 ...
 */
rt_inline void rt_spi_message_append(
    struct rt_spi_message *list, struct rt_spi_message *message)
{
    RT_ASSERT(list != RT_NULL);
    if (message == RT_NULL)
        return; /* not append */

    while (list->next != RT_NULL) { list = list->next; }
