...
#include <string.h>
#include <unistd.h>
#define DBG_TAG "example.file"
#define DBG_LVL DBG_INFO
#include <rtdbg.h>

#define EXAMPLE_FILE    "/data/file_example.txt"
#define EXAMPLE_MESSAGE "This is an rt-thread file system example"

int file_example(void)
{
    int fd;
...
MSH_CMD_EXPORT(file_example, file read and write example);
