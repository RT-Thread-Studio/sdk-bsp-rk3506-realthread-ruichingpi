...
def AddOptions():
    ...
    AddOption('--gen-sdk-config',
                dest = 'gen-sdk-config',
                type = 'string',
                help = 'Generate a SDK configuration file')
    AddOption('--gen-sdk',
                dest = 'gen-sdk',
                type = 'string',
                help = 'Generate a SDK')
    AddOption('--build-type',
                ...
                type = 'string',
                default = None,
                help = 'set BUILD_TYPE temperately, default is debug. ' +\
                'e.g. scons --build-type=release ' +\
                'or scons --build-type=debug')
    AddOption('--app_pkg',
                dest = 'app_pkg',
                type = 'string',
                help = 'application package')
