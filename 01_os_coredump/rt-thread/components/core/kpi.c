...
KPI_DEFINED(rt_tick_get_millisecond);
...
KPI_DEFINED(rt_device_pin_register);
KPI_DEFINED(rt_pin_mode);
KPI_DEFINED(rt_pin_write);
KPI_DEFINED(rt_pin_read);
KPI_DEFINED(rt_pin_get);
KPI_DEFINED(rt_pin_attach_irq);
KPI_DEFINED(rt_pin_detach_irq);
KPI_DEFINED(rt_pin_irq_enable);
KPI_DEFINED(rt_pin_debounce);
KPI_DEFINED(rt_pin_get_named_pin);
KPI_DEFINED(rt_pin_get_named_pin_count);
KPI_DEFINED(rt_ofw_get_named_pin);
KPI_DEFINED(rt_ofw_get_named_pin_count);
...
void kpi_init(void)
{
    ...
    rt_tick_get_millisecond = KPI_IMPORT(rt_tick_get_millisecond, 158);
    ...
    rt_dm_dev_get_address_by_name = KPI_IMPORT(rt_dm_dev_get_address_by_name, 1337);
    ...
    rt_dm_dev_prop_read_u8_array_index = KPI_IMPORT(rt_dm_dev_prop_read_u8_array_index, 1346);
    rt_dm_dev_prop_read_u16_array_index = KPI_IMPORT(rt_dm_dev_prop_read_u16_array_index, 1347);
    rt_dm_dev_prop_read_u32_array_index = KPI_IMPORT(rt_dm_dev_prop_read_u32_array_index, 1348);
    rt_dm_dev_prop_read_u64_array_index = KPI_IMPORT(rt_dm_dev_prop_read_u64_array_index, 1349);
    rt_dm_dev_prop_read_string_array_index = KPI_IMPORT(rt_dm_dev_prop_read_string_array_index, 1350);
    rt_dm_dev_prop_count_of_size = KPI_IMPORT(rt_dm_dev_prop_count_of_size, 1351);
    rt_dm_dev_prop_index_of_string = KPI_IMPORT(rt_dm_dev_prop_index_of_string, 1352);
    ...
    rt_platform_ofw_device_probe_child = KPI_IMPORT(rt_platform_ofw_device_probe_child, 1368);
    ...
    rt_ofw_machine_is_compatible = KPI_IMPORT(rt_ofw_machine_is_compatible, 1407);
    ...
    rt_ofw_find_node_by_compatible = KPI_IMPORT(rt_ofw_find_node_by_compatible, 1416);
    ...
    rt_ofw_get_child_by_compatible = KPI_IMPORT(rt_ofw_get_child_by_compatible, 1422);
    rt_ofw_get_child_count = KPI_IMPORT(rt_ofw_get_child_count, 1423);
    rt_ofw_get_available_child_count = KPI_IMPORT(rt_ofw_get_available_child_count, 1424);
    ...
    rt_ofw_get_next_available_child = KPI_IMPORT(rt_ofw_get_next_available_child, 1428);
    ...
    rt_ofw_prop_read_u8_array_index = KPI_IMPORT(rt_ofw_prop_read_u8_array_index, 1445);
    rt_ofw_prop_read_u16_array_index = KPI_IMPORT(rt_ofw_prop_read_u16_array_index, 1446);
    rt_ofw_prop_read_u32_array_index = KPI_IMPORT(rt_ofw_prop_read_u32_array_index, 1447);
    rt_ofw_prop_read_u64_array_index = KPI_IMPORT(rt_ofw_prop_read_u64_array_index, 1448);
    rt_ofw_prop_read_string_array_index = KPI_IMPORT(rt_ofw_prop_read_string_array_index, 1449);
    ...
    rt_clk_array_disable_unprepare = KPI_IMPORT(rt_clk_array_disable_unprepare, 1524);
    ...
    rt_clk_fixed_rate_unregister = KPI_IMPORT(rt_clk_fixed_rate_unregister, 1528);
    rt_clk_fixed_factor_register = KPI_IMPORT(rt_clk_fixed_factor_register, 1529);
    rt_clk_fixed_factor_unregister = KPI_IMPORT(rt_clk_fixed_factor_unregister, 1530);
    ...
    rt_completion_wait_flags_noisr = KPI_IMPORT(rt_completion_wait_flags_noisr, 1548);
    rt_completion_done = KPI_IMPORT(rt_completion_done, 1549);
    rt_completion_wakeup = KPI_IMPORT(rt_completion_wakeup, 1550);
    rt_completion_wakeup_by_errno = KPI_IMPORT(rt_completion_wakeup_by_errno, 1551);
    ...
    rt_wqueue_wait_interruptible = KPI_IMPORT(rt_wqueue_wait_interruptible, 1602);
    ...
    rt_workqueue_cancel_work_sync = KPI_IMPORT(rt_workqueue_cancel_work_sync, 1611);
    rt_workqueue_cancel_all_work = KPI_IMPORT(rt_workqueue_cancel_all_work, 1612);
    ...
    rt_i2c_bus_device_device_init = KPI_IMPORT(rt_i2c_bus_device_device_init, 1630);
    ...
    rt_spi_bus_attach_device_cspin = KPI_IMPORT(rt_spi_bus_attach_device_cspin, 1652);
    ...
    rt_device_pin_register = KPI_IMPORT(rt_device_pin_register, 1677);
    rt_pin_mode = KPI_IMPORT(rt_pin_mode, 1678);
    rt_pin_write = KPI_IMPORT(rt_pin_write, 1679);
    rt_pin_read = KPI_IMPORT(rt_pin_read, 1680);
    rt_pin_get = KPI_IMPORT(rt_pin_get, 1681);
    rt_pin_attach_irq = KPI_IMPORT(rt_pin_attach_irq, 1682);
    rt_pin_detach_irq = KPI_IMPORT(rt_pin_detach_irq, 1683);
    rt_pin_irq_enable = KPI_IMPORT(rt_pin_irq_enable, 1684);
    rt_pin_debounce = KPI_IMPORT(rt_pin_debounce, 1685);
    rt_pin_get_named_pin = KPI_IMPORT(rt_pin_get_named_pin, 1686);
    rt_pin_get_named_pin_count = KPI_IMPORT(rt_pin_get_named_pin_count, 1687);
    rt_ofw_get_named_pin = KPI_IMPORT(rt_ofw_get_named_pin, 1688);
    rt_ofw_get_named_pin_count = KPI_IMPORT(rt_ofw_get_named_pin_count, 1689);
